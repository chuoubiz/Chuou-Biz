                    ...
                    <div className="main">
                        ...
                        <div id="jobs">
                            ...
                            <table className="tbl">
                                ...
                                <tr>
                                    <th>仕事の内容</th>
                                    <td>一般事務及び浮気・素行・家出、嫌がらせ等に関するご相談に対し電話応対や面談し、お悩みについて問診、カウンセリングし契約交付。</td>
                                </tr>
                                <tr>
                                    <th>勤務地</th>
                                    <td>広島本社</td>
                                ...
                                <tr>
                                    <th>特徴</th>
                                    <td>つらい思いをして悩んでいる方のお力になれるお仕事です。<br />
                                    対話が得意な方、事務経験、営業経験、接客業経験者優遇します。</td>
                                </tr>
                                </tbody></table>
                            </div>
                            <div className="pb">
                            ...
                            <table className="tbl">
                                ...
                                <tr>
                                    <th>仕事の内容</th>
                                    <td>浮気・素行・結婚・所在調査、嫌がらせ対策等の事案に対し尾行、張り込み、聞き込み等の調査を行い報告書を作成する。</td>
                                </tr>
                                <tr>
                                    <th>勤務地</th>
                                    <td>広島本社</td>
                                ...
                                <tr>
                                    <th>特徴</th>
                                    <td>つらい思いをして悩んでいる方のお力になれるお仕事です。<br />
                                    機敏で臨機応変な対応ができる方が向いているお仕事と思います。</td>
                                </tr>
                                </tbody></table>
                            </div>
                            <div className="pb">
