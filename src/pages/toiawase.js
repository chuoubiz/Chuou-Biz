        ...
        <Layout>
          <div id={pagemeta.slug} className="main pb">
            <div id="contact_line" className="cf pb">
              ...
              <p>
                <img src="../img/contact/line_logo.png" alt="" />
              </p>
              <p className="b fm">LINEからお問い合わせできます！</p>
              <div className="dsp_hp">
                <p className="img_rit">
                  <img src="../img/contact/qr.gif" alt="" />
                </p>
                <p>
                  QRコードから
                  <a
              ...
              <div className="dsp_tbs">
                ...
                <p className="cen nm">
                  <a
                    href="https://line.me/R/ti/p/%40zmg2410c"
                    target="_blank"
                    rel="nofollow noopener noreferrer"
                  >
                    <img
                    ...
                    <dl className="box02_flex">
                      ...
                      <dd className="tel_area">
                        <a href="tel:0120-30-6630" className="tel tel_m sans">
                          <img src="../img/free.png" alt="フリーダイヤル" />
                          0120-30-6630
                        </a>
            ...
            <div className="pb">
              ...
              <form
                action="https://ssgform.com/s/1IVlQDYBc4CR"
                method="post"
                id="mailform"
              >
...
const jsonN = "広島探偵 中央リサーチ",
  ...
  jsonS = "toiawase",
  jsonD =
    "広島の探偵社「中央リサーチ」ではどのようなお問い合わせにも対応致します。お気軽にご連絡ください。";
