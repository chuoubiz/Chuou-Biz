...
const toiawase = () => {
  ...
  return (
    <>
      <div id="wrap">
        <HeaderShimane
          h1title="ご相談、お問い合わせについて"
          pagetitle="JR松江駅前にある探偵事務所"
        />
        ...
        <Layout>
          <div id={pagemeta.slug} className="main">
            <div id="contact_line" className="cf pb">
              ...
              <p>
                <img
                  src="../../img/shimane/contact/line_logo.png"
                  width={151}
                  height={41}
                  alt=""
                />
              ...
              <div className="dsp_hp">
                <p className="img_rit">
                  <img
                    src="../../img/shimane/contact/qr.gif"
                    width={170}
                    height={170}
                    alt=""
                  />
                ...
                <p>
                  ...
                  <br />
                  LINEアプリの【友だち追加】で右のQRコードを読み取って、トークからお問い合わせください。
                </p>
              </div>
              <div className="dsp_tbs">
                <p>
                  ...
                  をタップすると、LINEでお問い合わせができます。
                </p>
                <p className="cen nm">
                  <a href="https://line.me/R/ti/p/%40zmg2410c">
                    <img
            ...
            <div id="contact_tel" className="pb">
              ...
              <p className="red">
                はじめての方も、お気軽にご相談ください！小さな問題でも丁寧に対応させていただきます。
              </p>
              <p>
                お電話でのご相談の場合、下記フリーダイヤルまでお問い合わせください。年中無休・24時間対応いたしております。（携帯電話からもOK）
              </p>
              <div id="beginner_msg">
                <div className="msg_box02">
                  <div className="txt_area">
                    <dl className="box02_flex">
                      <dt>
                        <span className="txt_free mp">
                          無料<span>相談窓口</span>
                        </span>
                      </dt>
                      <dd className="tel_area">
                        <a href="tel:0120-30-6630" className="tel tel_m sans">
                          <img
                            src="../../img/shimane/free.png"
                            alt="フリーダイヤル"
                          />
                          0120-30-6630
                        </a>
                        <p className="msg_txt04">
                          女性相談員ご希望の方はこちら
                        </p>
                        <a href="tel:0120-20-3399" className="tel sans">
                          <img
                            src="../../img/shimane/free.png"
                            alt="フリーダイヤル"
                          />
                    ...
                    <p className="msg_txt05">
                      年中無休！ 24時間受付！<span>携帯電話でもOK!</span>
                    </p>
                  </div>
                </div>
              </div>
              <p className="red b a_note">
                ※営業、セールスのお電話は一切お断り致します。
              </p>
            </div>
            <div className="pb">
              ...
              <p className="red">
                メールでのご相談も24時間年中無休で受け付けておりますが、お急ぎの場合はフリーダイヤルへお願いいたします。
              </p>

              <form
                action="https://ssgform.com/s/GJmU4VO0qePD"
                method="post"
                id="mailform"
              >
                ...
                <table className="tbl">
                  <tbody>
                    <tr>
                      <th>
                        <span className="need">必須</span>調査エリア
                      </th>
                      <td>
                        <label>
                          <input
                    ...
                    <tr>
                      <th>
                        <span className="need">必須</span>お名前
                      </th>
                      <td>
                        <input
                          type="text"
                          ...
                          className="active"
                        />{" "}
                        <span className="thin">※ニックネーム可</span>
                      </td>
                    </tr>
                    <tr>
                      <th>郵便番号</th>
                      <td>
                        <input
                          ...
                          name="郵便番号"
                          size={10}
                          className="disabled wno"
                        />
                        &nbsp;
                        <input
                          type="button"
                          defaultValue="〒から住所を自動入力"
                          onclick="mfpc('mailform','郵便番号','住所');"
                        />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th>
                        <span className="need">必須</span>メールアドレス
                      </th>
                      <td>
                        <input
                          type="text"
                    ...
                    <tr>
                      <th>
                        <span className="need">必須</span>ご用件
                      </th>
                      <td>
                        <label>
                          <input
                    ...
                    <tr>
                      <th>
                        <span className="need">必須</span>お問い合わせ内容
                      </th>
                      <td>
                        <textarea
                          name="お問い合わせ内容"
                ...
                <div className="btn">
                  ...
                  <div className="recap_box">
                    <div
                      ...
                      data-sitekey="6LeXfjsnAAAAANdy2jGk320IIYkzJZ-fOtK33XCN"
                    />
                  </div>
                  <p className="cen">
            ...
            <div className="pt pb">
              ...
              <p>
                中央リサーチでは、ヤフー株式会社をはじめとする第三者から配信される広告が掲載される場合があり、これに関連して、当該第三者が、当ウェブサイトを訪問したユーザーのクッキー情報等を取得し、利用している場合があります。
                <br />
