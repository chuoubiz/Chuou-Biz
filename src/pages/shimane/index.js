        ...
        <section id='container' className='cf'>
          ...
          <div className='main'>
            <div id='top_menu' className='bg_wide pt pb shimane'>
              <StaticImage src='../../img/success_txt01.webp' alt='調査成功率98.8%' className='top_success_img' />
            ...
            <div id='about'>
              <div id='shimane_about' className='main bg_wide pt pb'>
                ...
                <p className='link nm'>
                  <Link to='/shimane/jirei/'>調査事例はこちら</Link>
                </p>
              </div>
            </div>
            <div id='shimane_promise' className='bg_wide pt'>
              ...
              <div className='box_flex bg_wide'>
                <dl>
                  <dt>
                    <img src='../../img/shimane/img_promise01.jpg' alt='' />
                    <b className='mp'>秘密厳守</b>
                  </dt>
                  <dd>ご安心下さい。調査の秘密が第三者に漏洩することはございません。更に報告書を提出後、調査で知りえた個人情報は責任を持ってシュレッダーにて破棄いたします。</dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/img_promise02.jpg' alt='' />
                    <b className='mp'>即日調査可能</b>
                  </dt>
                  <dd>
                    迅速な対応で怪しい日を逃すことなく調査を行います。
                    <br />
                    ベテラン探偵調査員が24時間年中無休で対応いたします。
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/img_promise03.jpg' alt='' />
                    <b className='mp'>確かな調査力</b>
                  </dt>
                  <dd>
                    業界トップクラスの調査力を誇る探偵社です。
                    <br />
                    弁護士事務所や警察OBとの連携により、高い調査能力でご安心をお届けいたします。
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/img_promise04.jpg' alt='' />
                    <b className='mp'>格安価格</b>
                  </dt>
                  <dd>
                    弊社では口コミでの紹介事案が数多くあり大幅に広告宣伝費を削減しています。
                    <br />
                    無駄を削減する事で予算をお客様の料金に充当する格安料金を実現しています。
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/img_promise05.jpg' alt='' />
                    <b className='mp'>まごころ調査</b>
                  </dt>
                  <dd>結果が出るまで親身になって調査いたします。他社にご依頼されても結果が出なかった方、当社は必ずお力になる事をお約束いたします。</dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/img_promise06.jpg' alt='' />
            ...
            <div id='shimane_6reason' className='bg_wide pt'>
              ...
              <ol>
                <li>
                  弊社相談員は、お客様のお話にしっかりと耳を傾け、問題解決に向けてお客様と共に考え、<b className='red'>個々のケースに相応しいアドバイス</b>をいたしております。
                </li>
                <li>調査料金等のお見積もりは必ず事前にご提示し、お客様に納得いただけるようきちんとご説明しております。後から勝手に追加料金を請求することはありません。</li>
                <li>
                  弊社調査員は、豊富な経験と高度な技術力を活かし、目的達成へ向けて全力を尽くします。<b className='red'>無責任、不適切な調査はいたしません。</b>
                </li>
                <li>
                  調査方法・日程等については、お客様と打ち合わせの上で決定し、<b className='red'>進行状況は必要に応じて随時ご報告</b>しております。お客様の承諾なく、勝手な延長・打ち切りを行うことはありません。
                </li>
                <li>
                  調査報告書は、<b className='red'>詳細かつ証拠能力の高いものを作成</b>しております。弊社の報告書は大変多くのお客様にご満足いただけております。
                </li>
                <li>
                  調査終了後も、お客様の抱える問題の解決へ向け、<b className='red'>アフターケアも対応</b>させていただいております。どうぞ安心してご相談下さい。
                </li>
              </ol>
              <div className='txt'>
              ...
              <div className='photo'>
                <img src='../../img/shimane/img_reason02.png' width={352} height={360} alt='' />
              </div>
            </div>
            <div id='shimane_button'>
              <p className='link mp pt pb'>
                <Link to='/shimane/voice/'>お客様の声はこちら</Link>
              </p>
            </div>
              ...
              <div className='box'>
                ...
                <div className='wrap'>
                  ...
                  <dl className='plan w3'>
                    ...
                    <dd>
                      <p>
                        19万円<span className='fs'>（税込 209,000円）</span>、調査員2名体制<span className='fs'>（20時間を数日間にわけて調査致します）</span>
                      </p>
                  ...
                  <dl className='plan w3'>
                    ...
                    <dd>
                      <p>
                        28万円<span className='fs'>（税込 308,000円）</span>、調査員2名体制<span className='fs'>（30時間を数日間にわけて調査致します）</span>
                      </p>
            ...
            <div id='top_evidence'>
              <div className='sample pb'>
                ...
                <p className='cen'>
                  <img src='../../img/shimane/sample08.png' alt='' className />
                </p>
                <p className='link mp'>
            ...
            <div id='top_profile'>
              <h3 className='mp bg_wide shimane'>
              ...
              <div className='bg bg_wide pb'>
                <dl>
                  <dt>
                    <img src='../../img/shimane/profile_name01.png' alt='' />
                  </dt>
                  <dd>
                    <img src='../../img/shimane/profile_txt01.png' alt='' className='dsp_hpt' />
                    <img src='../../img/shimane/profile_txt01_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/profile_name02.png' alt='' />
                  </dt>
                  <dd>
                    <img src='../../img/shimane/profile_txt02.png' alt='' className='dsp_hpt' />
                    <img src='../../img/shimane/profile_txt02_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <img src='../../img/shimane/profile_name03.png' alt='' />
                  </dt>
                  <dd>
                    <img src='../../img/shimane/profile_txt03.png' alt='' className='dsp_hpt' />
                    <img src='../../img/shimane/profile_txt03_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
                <dl>
                  <dt>
                  ...
                  <dd>
                    <img src='../../img/shimane/profile_txt04.png' alt='' className='dsp_hpt' />
                    <img src='../../img/shimane/profile_txt04_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div id='top_faq' className='pt pb'>
              ...
              <div className='list'>
                <dl>
                  <dt>
                    <span>Q</span>対象者が敏感で警戒心が強いのですが、対象者に気づかれないように調査できるものでしょうか？
                  </dt>
                  <dd>
                    <span>A</span>調査経験１０年以上の探偵が調査にあたりますので、今までの経験を活かし、たとえ難しい調査事案でも工夫や予測を行い調査目的を達成いたしますのでご安心ください。
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <span>Q</span>浮気相手の情報（氏名・住所・勤務先・家族構成）などを割り出すことは可能ですか？
                  </dt>
                  <dd>
                    <span>A</span>基となる情報から、プロによる、あらゆる方法での情報収集を行います。内偵調査のご依頼でお調べは可能です。
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <span>Q</span>浮気を疑い、私（妻）自身がGPSを車に取り付けたら、夫（対象者）に気づかれました。どうしたら良いでしょう？
                  </dt>
                  <dd>
                    <span>A</span>浮気をしている対象者は、もともと悪いことをしている自覚を持ち警戒しながら動きます。疑われたら「GPSが取り付けられているかも知れない？」という発想は、すでに織り込まれており、そう予測するものなのです。対象者に気づかれる前に、証拠取りのプロにお任せください。
                  </dd>
                </dl>
                <dl>
                  <dt>
                    <span>Q</span>ネットでの誹謗中傷、嫌がらせや、悪いうわさなど流されていないか気になり夜も眠れません。自分ではどうしたら良いのか分かりません。何か良い方法はありませんか？
                  </dt>
                  <dd>
                    <span>A</span>ネット上での誹謗中傷やSNS、掲示板への書き込み、近隣からのうわさなど、情報収集することで事実関係を確認することができますのでご安心ください。名誉棄損に抵触する事実があれば弁護士などのご紹介もいたします。
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div id='top_shimane' className='bg_wide pb'>
              ...
              <div className='wrap'>
                <div className='img'>
                  <p>
                    <img src='../../img/shimane/img_yamaguchi.jpg' alt='' />
                    <br />
                    プライバシーを守る相談室
                  </p>
                </div>
                <p className='map'>
                  <a href='https://goo.gl/maps/2rJuQAmFp2RPNTJq9' rel='nofollow noopener noreferrer' target='_blank' aria-label='GoogleMap'>
                    <img src='../../img/shimane/map.png' loading='lazy' alt='' />
                  </a>
                </p>
              </div>
              <div className='photo'>
                ...
                <ul className='box_flex'>
                  <li>
                    <img src='../../img/shimane/img_company01.jpg' alt='' />
                  </li>
                  <li>
                    <img src='../../img/shimane/img_company02.jpg' alt='' />
                  </li>
                  <li>
                    <img src='../../img/shimane/img_company03.jpg' alt='' />
                  </li>
                </ul>
              </div>
            </div>
            <div id='top_koukoku' className='pt pb'>
              <div className='box_flex mb'>
                <div className='line'>
                  <div className='in'>
                    <p>
                      <img src='../../img/shimane/logo_line.png' alt='' />
                    </p>
                    <p className='b'>
                      LINEからお問い合わせ
                      <br className='dsp_smt' />
                  ...
                  <p className='qr'>
                    <img src='../../img/shimane/qr_line.png' alt='' />
                  </p>
                </div>
                <dl className='card'>
                  ...
                  <dd>
                    <p>
                      <img src='../../img/shimane/img_card01.png' alt='' />
                    </p>
                    <p>
                      <img src='../../img/shimane/img_card02.png' alt='' />
                    </p>
                  </dd>
                </dl>
              </div>
              ...
              <ul>
                <li>
                  <a href='http://www.ncia-research.or.jp/' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/shimane/bana01.png' alt='全国調査業協同組合' />
                  </a>
                </li>
                <li>
                  <a href='https://www.pref.shimane.lg.jp/police/' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/shimane/shimane-p.jpg' alt='島根県警察' />
                  </a>
                </li>
                <li>
                  <a href='https://rikon.vbest.jp/' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/shimane/bana03.png' alt='ベリーベスト法律事務所' />
                  </a>
                </li>
                <li>
                  <a href='https://best-legal.jp/want-to-claim-affair-alimony-3366' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/shimane/bana04.png' alt='不倫・浮気の慰謝料請求ならベリーベスト法律事務所' />
                  </a>
                </li>
              </ul>
            </div>
            <div id='top_area' className='bg_wide pt pb'>
              <h3 className='mp'>
                <b className='fm'>全国対応</b>いたします<b className='ok'>海外もOK!</b>
              </h3>
              <div className='box'>
