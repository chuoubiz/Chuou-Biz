        ...
        <Layout>
          <div id={pagemeta.slug} className="main">
            <div id="contact_line" className="cf pb">
              ...
              <p>
                <img
                  src="../../img/yamaguchi/contact/line_logo.png"
                  width={151}
                  height={41}
                  alt=""
                />
              ...
              <div className="dsp_hp">
                <p className="img_rit">
                  <img
                    src="../../img/yamaguchi/contact/qr.gif"
                    width={170}
                    height={170}
                    alt=""
                  />
                ...
                <p>
                  QRコードから
                  <Link
                    to="https://line.me/R/ti/p/65gpK3qcDs"
              ...
              <div className="dsp_tbs">
                ...
                <p className="cen nm">
                  <Link to="https://line.me/R/ti/p/%40zmg2410c">
                    <img
            ...
            <div id="contact_tel" className="pb">
              ...
              <p>
                お電話でのご相談の場合、下記フリーダイアルまでお問い合わせください。年中無休・24時間対応いたしております。（携帯電話からもOK）
              </p>
              <div id="beginner_msg">
                  ...
                  <div className="txt_area">
                    <dl className="box02_flex">
                      ...
                      <dd className="tel_area">
                        <Link to="tel:0120-30-6630" className="tel tel_m sans">
                          <img
                            src="../../img/yamaguchi/free.png"
                            alt="フリーダイヤル"
                          />
                          0120-30-6630
                        </Link>
                        ...
                        <Link to="tel:0120-20-3399" className="tel sans">
                          <img
                            src="../../img/yamaguchi/free.png"
                            alt="フリーダイヤル"
                          />
            ...
            <div className="pb">
              ...
              <p className="red">
                メールのご相談は24時間年中無休で受け付けておりますが、お急ぎの場合はフリーダイヤルへお願いいたします。
              </p>

              <form
                action="https://ssgform.com/s/FciPQ52UaVsb"
                method="post"
                id="mailform"
              >
