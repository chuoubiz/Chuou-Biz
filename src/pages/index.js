  ...
  return (
    <>
      ...
      <section id='container' className='cf'>
        <div id='page_title'>
          <StaticImage src='../img/top/title.webp' width={1300} height={475} loading='lazy' alt='総合探偵社中央リサーチ' className='dsp_hpt' />
          <StaticImage src='../img/top/title_sp.webp' width={414} height={342} alt='総合探偵社中央リサーチ' className='dsp_smt' />
        </div>
      ...
      <section id='topmenu' className='cf'>
        <div className='topmenu'>
          <StaticImage src='../img/success_txt01.webp' alt='調査成功率98.8%' width={389} height={211} className='top_success_img' />
      ...
      <section id='toppromise' className='cf'>
        <div className='toppromise'>
          <div id='top_promise'>
            <h3 className='mp'>
              お客様との<span className='fm'>6</span>つの約束
            </h3>
            <div className='wrap'>
              <div className='box'>
                <p className='no'>1</p>
                <h4 className='mp'>即日調査可能</h4>
                <p className='ttl serif'>
                  解決までの
                  <br />
                  対応トップクラス
                </p>
              ...
              <div className='box'>
                ...
                <p className='bg_gray nm'>
                  探偵業法及び法令を順守した上で、迅速かつ確実な調査を責任をもってお引き受けいたします。
                  <br />
                  トップクラスの調査能力や調査技術開発力を持つ当探偵社をご利用くださいませ。
                </p>
              </div>
              <div className='box'>
                <p className='no'>5</p>
              ...
              <div className='box'>
                ...
                <p className='bg_gray nm'>
                  調査結果に基づき、今後の対策、再発防止策等、最良な方法を責任もってアドバイス致します。
                  <br />
                  必要に応じて、事案内容が得意とされる有能な弁護士を無料でご紹介する事も可能です。
                </p>
              </div>
            </div>
          </div>
          ...
          <div id='top_reason'>
            <div className='in'>
              ...
              <div className='waku'>
                <ul>
                  <li>
                    <span className='fs dsp_hpt'>お客様から、</span>
                    安心・ご納得される料金形態
                  </li>
                  <li>
                    <span className='fs dsp_hpt'>お客様から、</span>
          ...
          <div id='top_faq' className='pt pb'>
            ...
            <div className='list'>
              <dl>
                <dt>
                  <span>Q</span>
                  浮気調査を依頼しても何の成果も出ない事はありますか？
                </dt>
                <dd>
                  <span>A</span>
                  弊社の実績では、浮気調査のご依頼の8割のお客様が20時間プランです。
                  <br />
                  その結果、有る答えの調査では、9割以上浮気の動かぬ証拠が撮れています。
                </dd>
              </dl>
            </div>
            <p className='rit'>
              <Link to='/faq/'>その他質問はこちら »</Link>
            </p>
          </div>

          <div id='top_support' className='bg_wide pt pb'>
            <h3 className='serif'>
              <span>全力</span>であなたの<span>幸せを勝ち取るサポート</span>
              をいたします。
            </h3>
            <p className='img cen'>
          ...
          <div id='top_corona' className='bg_wide pt pb'>
            ...
            <div className='wrap'>
              <dl>
                ...
                <dd>
                  <p className='ico nm'>
                    <img src='../img/top/corona01.png' width={97} height={75} alt='アルコール消毒液の設置' loading='lazy' />
                  </p>
              ...
              <dl>
                ...
                <dd>
                  <p className='ico nm'>
                    <img src='../img/top/corona02.png' width={96} height={80} alt='スタッフのマスク着用' loading='lazy' />
                  </p>
              ...
              <dl>
                ...
                <dd>
                  <p className='ico nm'>
                    <img src='../img/top/corona03.png' width={94} height={81} alt='スタッフの検温の確認' loading='lazy' />
                  </p>
          ...
          <div id='top_koukoku' className='pb'>
            <div className='list'>
              <dl className='dsp_hp'>
                ...
                <dd className='b'>
                  ご契約に際し、当探偵社は必ず重要事項説明書・利用目的確認書・契約書を交付後、それに基づくお支払い分、以外に料金を請求する事は一切ございません。
                  <br />
                  当探偵社は類似社名などの業者とは一切関係ございません。
                  <br />
                  同一の会社であるかの確認は電話番号が一致しているかをご確認ください。
                </dd>
              </dl>
              <dl>
            ...
            <ul>
              <li>
                <a href='https://www.pref.hiroshima.lg.jp/site/police/' rel='nofollow noopener noreferrer' target='_blank'>
              ...
              <li>
                <a href='https://rikon.vbest.jp/' rel='nofollow noopener noreferrer' target='_blank'>
                  <img src='../img/top/very_best.png' width={226} height={49} loading='lazy' alt='ベリーベスト法律事務所' />
                </a>
              </li>
              <li>
                <a href='https://best-legal.jp/want-to-claim-affair-alimony-3366/' rel='nofollow noopener noreferrer' target='_blank'>
                  <img src='../img/top/20210416.png' width={220} height={46} loading='lazy' alt='浮気や不倫お役立ち情報はコチラ' />
                </a>
              </li>
              <li id='ikuchan'>
                <a href='http://www.ikuchan.or.jp/service/' rel='nofollow noopener noreferrer' target='_blank'>
                  <img src='../img/top/ikuzennkoku.jpg' width={108} height={115} loading='lazy' alt='子育て応援イクちゃんサービス' />
                  <span className='txt'>
                    お子様連れ大歓迎です。弊社は、
                    <b className='orange'>イクちゃんサービス参加店</b>
                    に登録しております。
                  </span>
                </a>
              </li>
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'LocalBusiness',
      name: '広島で選ばれる探偵｜中央リサーチ｜実績55年の浮気・不倫調査専門',
...
export const Head = () => (
  <>
    <Seo title2='広島で選ばれる探偵｜中央リサーチ｜実績55年の浮気・不倫調査専門' description='広島の信頼できる探偵 - 中央リサーチは、55年の実績で浮気・不倫の総合調査を得意とし、迅速かつ確実な証拠収集をお約束します。料金は明瞭で、初回相談は無料。広島市中区にあり、広島県公安委員会に正式に届け出ている安心の探偵社です。' />
