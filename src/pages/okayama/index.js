...
const index = () => {
  return (
    <>
      <div id='wrap'>
        <HeaderOkayama h1title='岡山の探偵｜浮気調査は55年の実績と信頼｜総合探偵社中央リサーチ岡山' pagetitle='岡山駅より徒歩5分の探偵事務所' />
            ...
            <div className='main pt pb'>
              ...
              <div className='box_flex'>
                <dl>
                  <dt>
                    <b className='mp'>1</b>
                    <img src='../../img/okayama/img_reason01.jpg' width={450} height={300} alt='' />
                  </dt>
                  <dd>
                    <p className='ttl mp'>
                      知識と経験、
                ...
                <dl>
                  <dt>
                    <b className='mp'>2</b>
                    <img src='../../img/okayama/img_reason02.jpg' width={450} height={300} alt='' />
                  </dt>
                  <dd>
                    <p className='ttl mp'>
                      業界最安値の
                ...
                <dl>
                  <dt>
                    <b className='mp'>3</b>
                    <img src='../../img/okayama/img_reason03.jpg' width={450} height={300} alt='' />
                  </dt>
                  <dd>
                    <p className='ttl mp'>
                      全国約300名の
                ...
                <dl>
                  <dt>
                    <b className='mp'>4</b>
                    <img src='../../img/okayama/img_reason04.jpg' width={450} height={300} alt='' />
                  </dt>
                  <dd>
                    <p className='ttl mp'>
                      中四国最大級の
                ...
                <dl>
                  <dt>
                    <b className='mp'>5</b>
                    <img src='../../img/okayama/img_reason05.jpg' width={450} height={300} alt='' />
                  </dt>
                  <dd>
                    <p className='ttl mp'>
                      当探偵社は特殊な事案でも
                ...
                <dl>
                  <dt>
                    <b className='mp'>6</b>
                    <img src='../../img/okayama/img_reason06.jpg' width={450} height={300} alt='' />
                  </dt>
                  <dd>
                    <p className='ttl mp'>
                      裁判になっても
          ...
          <div className='main'>
            ...
            <div id='top_profile'>
              ...
              <div className='bg bg_wide pb'>
                <dl>
                  ...
                  <dd>
                    <img src='../../img/okayama/profile_txt01.png' alt='' className='dsp_hpt' />
                    <img src='../../img/okayama/profile_txt01_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
                <dl>
                  <dt>
                  ...
                  <dd>
                    <img src='../../img/okayama/profile_txt02.png' alt='' className='dsp_hpt' />
                    <img src='../../img/okayama/profile_txt02_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
                <dl>
                  <dt>
                  ...
                  <dd>
                    <img src='../../img/okayama/profile_txt03.png' alt='' className='dsp_hpt' />
                    <img src='../../img/okayama/profile_txt03_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
                <dl>
                  <dt>
                  ...
                  <dd>
                    <img src='../../img/okayama/profile_txt04.png' alt='' className='dsp_hpt' />
                    <img src='../../img/okayama/profile_txt04_sp.png' alt='' className='dsp_smt' />
                  </dd>
                </dl>
              </div>
            </div>
              ...
              <div className='bg'>
                ...
                <div className='wrap'>
                  ...
                  <dl>
                    <dt>広島相談室</dt>
                    <dd>
                      <a href='https://www.chuou.biz/'>総合探偵社中央リサーチ広島</a>
                      <br />
            ...
            <div id='top_hiroshima' className='bg_wide pb okayama'>
              ...
              <div className='wrap'>
                ...
                <p className='map'>
                  <a href='https://goo.gl/maps/Eyr7fYEAtyhkFcBN7' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/okayama/map.png' loading='lazy' alt='' />
                  </a>
                </p>
              </div>
            </div>
            <div id='top_koukoku' className='pt pb'>
              ...
              <ul>
                <li>
                  <a href='http://www.ncia-research.or.jp/' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/okayama/bana01.png' alt='全国調査業協同組合' />
                  </a>
                </li>
                <li>
                  <a href='https://www.pref.okayama.jp/site/kenkei/' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/okayama/okayama_p.png' alt='岡山県警察' />
                  </a>
                </li>
                <li>
                  <a href='https://rikon.vbest.jp/' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/okayama/bana03.png' alt='ベリーベスト法律事務所' />
                  </a>
                </li>
                <li>
                  <a href='https://best-legal.jp/want-to-claim-affair-alimony-3366' rel='nofollow noopener noreferrer' target='_blank'>
                    <img src='../../img/okayama/bana04.png' alt='不倫・浮気の慰謝料請求ならベリーベスト法律事務所' />
                  </a>
                </li>
              </ul>
            </div>
...
const jsonN = '岡山の探偵｜浮気調査は55年の実績と信頼｜総合探偵社中央リサーチ岡山',
  jsonS = 'okayama',
  jsonD = '探偵で岡山の調査なら｢浮気調査、不倫調査」を最も得意とする総合探偵社中央リサーチ岡山が高いスキルで浮気の証拠をとり早期解決に導きます。分かりやすい料金表でお見積り、ご相談無料です。所在地　岡山県岡山市北区富田町１－１－１藤野ビル2階（JR岡山駅から徒歩5分）岡山県公安委員会届け出済み';
