            ...
            <div className='main bg_wide pb'>
              ...
              <div className='box_flex pb'>
                <dl id='uwaki'>
                  ...
                  <dd>
                    ...
                    <br />
                    <p className='link nm'>
                      <Link to='/okayama/jirei/#case01'>調査事例はこちら</Link>
                    </p>
                  </dd>
                </dl>
                <dl id='saiban'>
                ...
                <dl id='konzen'>
                  ...
                  <dd>
                    ...
                    <p className='link nm'>
                      <Link to='/okayama/jirei/#case04'>調査事例はこちら</Link>
                    </p>
                  </dd>
                </dl>
                <dl id='sokou'>
                ...
                <dl id='iede'>
                  ...
                  <dd>
                    ...
                    <p className='link nm'>
                      <Link to='/okayama/jirei/#case05'>調査事例はこちら</Link>
                    </p>
                  </dd>
                </dl>
                <dl id='stalker'>
                  ...
                  <dd>
                    ...
                    <p className='link nm'>
                      <Link to='/okayama/jirei/#case03'>調査事例はこちら</Link>
                    </p>
                  </dd>
                </dl>
                <dl id='touchouki'>
              ...
              <div id='houjin' className='pad_anchor'>
                ...
                <div className='box_flex'>
                  <dl>
                    <dt>
                      <img src='../../img/okayama/about/img09.jpg' alt='' />
                      <b className='mp'>企業信用調査</b>
                    </dt>
                    <dd>新しく取引を開始するにあたり、その会社の経営状態、業績、財務状況、規模、成長性、評価など会社の信用度を側面からお調べいたします。必要に応じて、代表者の人物性や風評、生活実態なども調査可能です。</dd>
                  </dl>
                  <dl>
                    <dt>
                      <img src='../../img/okayama/about/img10.jpg' alt='' />
                      <b className='mp'>採用調査</b>
                    </dt>
                    <dd>新しく従業員を採用するにあたり、会社に損害を与えるような人物ではないか、面接や履歴書などの表面上では解りにくい、隠された本当の人物性や経歴、評価、思想などを側面からお調べいたします。</dd>
                  </dl>
                  <dl>
                    <dt>
                      <img src='../../img/okayama/about/img11.jpg' alt='' />
                      <b className='mp'>市場調査</b>
                    </dt>
                    <dd>新しくお店を出店したり、開業を検討されておられる方など、交通量や場所、相乗効果などの市場性をプロの視点で情報収集し、成功するための参考資料にお役立ていただけます。</dd>
                  </dl>
                  <dl>
                    <dt>
                      <img src='../../img/okayama/about/img12.jpg' alt='' />
                      <b className='mp'>従業員の素行</b>
                    </dt>
                    <dd>
                      現在、雇用されている従業員の規約違反や不正などの疑いがある場合、該当の従業員の勤務実態などを、分単位で記録し証拠を撮る調査です。解雇の際に、不当解雇と主張する事を否定できます。
                      <br />
                      <p className='link nm'>
                        <Link to='/okayama/jirei/#case02'>調査事例はこちら</Link>
                      </p>
                    </dd>
                  </dl>
                  <dl>
                    <dt>
                      <img src='../../img/okayama/about/img13.jpg' alt='' />
                      <b className='mp'>危機管理</b>
                    </dt>
                    <dd>会社内での盗聴・盗撮・情報漏洩や不正アクセスなど、大きなトラブルに発展しないための危機管理を行います。</dd>
                  </dl>
                  <dl>
                    <dt>
                      <img src='../../img/okayama/about/img14.jpg' alt='' />
                      <b className='mp'>交通事故調査</b>
                    </dt>
...
export const Head = () => (
  <>
    <Seo title2='調査項目｜総合探偵社中央リサーチ岡山' description='岡山の興信所・探偵社の中央リサーチ岡山の調査項目について。浮気調査を最も得意とする探偵社です。ご依頼者様の心のお悩みを解決し、平穏な日々を取り戻せるよう全力を尽くします。浮気調査に多くの実績を持つ当社にお任せください。' keyword='調査項目,探偵,岡山,興信所,浮気調査,中央リサーチ岡山' />
  </>
);
