    ...
    <>
      <footer id="footer">
        ...
        <div id="footer_btn">
          <ul>
            <li className="mail">
              <Link to="/yamaguchi/toiawase/">
                <img src="../../img/btn_mail.png" alt="メールで相談" />
              </Link>
            </li>
            <li className="line">
              <a
                ...
                target="_blank"
              >
                <img src="../../img/btn_line.png" alt="LINEで相談" />
              </a>
            </li>
            <li className="tel">
              <a href="tel:0120-30-6630" aria-label="電話で相談">
                <img src="../../img/btn_tel.png" alt="電話で相談" />
              </a>
            </li>
          </ul>
        </div>
        ...
        <p id="copyright">
          Copyright &copy; 2022 株式会社中央リサーチ山口. All Rights Reserved.
        </p>
      </footer>
    </>
  );
